...
public class Scheme extends BaseModel { 
	public String primary_responsibiity ;
	public String secondary_responsibility ;
	...
	public Integer sector_name;
	public String financial_year;
	public Date from_date;
	public Date to_date;
	public String first_name;
	public String getPrimary_responsibiity() {
		return primary_responsibiity;
	}
	public void setPrimary_responsibiity(String primary_responsibiity) {
		this.primary_responsibiity = primary_responsibiity;
	}
	public String getSecondary_responsibility() {
		return secondary_responsibility;
	}
	public void setSecondary_responsibility(String secondary_responsibility) {
		this.secondary_responsibility = secondary_responsibility;
	}
	...
	public Integer getSector_name() {
		return sector_name;
	}
	public void setSector_name(Integer sector_name) {
